...
const CDNURL = "https://ynczawungvgebbdeyysm.supabase.co/storage/v1/object/public/images/";
...
function App() {
  ...
  return (
    <Container align="center" className="container-sm mt-4">
      ...
      { user === null ? 
        <>
          <h1>Welcome to ImageInventory</h1>
          <Form>
      ...
      : 
        <>
          <h1>Your ImageInventory</h1>
          <Button onClick={() => signOut()}>Sign Out</Button>
          <p>Current user: {user.email}</p>
          <p>Use the Choose File button below to upload an image to your inventory</p>
          <Form.Group className="mb-3" style={{maxWidth: "500px"}}>
